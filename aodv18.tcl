...
set tracefd       [open testAODV-2.tr w]
set windowVsTime2 [open win-2.tr w]
set namtrace      [open testAODV-2.nam w]
...
# configure the nodes
    ...
    # } 
        ...
        set node_(0) [$ns node]
        $node_(0) set X_ [ expr 10+400 ]
        $node_(0) set Y_ [ expr 10+300 ]
        $node_(0) set Z_ 0.0
    
        set node_(1) [$ns node]
        $node_(1) set X_ [ expr 10+300 ]
        $node_(1) set Y_ [ expr 10+200 ]
        $node_(1) set Z_ 0.0
